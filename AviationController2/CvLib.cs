...
namespace AviationController2
{
    public class CvLib
    {
        ...
        double degPitch, degRole, degHedading;
        int cmd;
        ...
        public void show()
        {
            try
            {
                ...
                using (var capture = CvCapture.FromCamera(1))
                {
                    IplImage frame;
                    ...
                    while (true)
                    {
                        ...
                        IplImage capturedImg = rotate(frame, degRole);
                        IplImage edit = areaCorrTrack(rotate(frame,degRole), c);
                        ...
                        //Cv.ShowImage("edit", drawReticle(edgeTrack2(rotate(frame, degRole), c)));
                        //Cv.ShowImage("edit", drawReticle(edgeTrack2(rotate(frame, degRole),0)));
                        //Cv.ShowImage("edit", drawReticle(edgeTrack(corrTrack(rotate(frame, degRole), c), c)));
                        //Cv.ShowImage("edit", edgeTrack2(corrTrack(rotate(frame,degRole), c),c));
                        //Cv.ShowImage("edit", edgeTrack2(rotate(frame,degRole),c));
        ...
        private IplImage corrTrack(IplImage src,int cmd){
            if(prevImage == null){
